<template>
    <div class="min-h-screen">
        ...
        <!-- Skill not found -->
        <div v-if="!skill" class="min-h-screen flex items-center justify-center">
            <div class="text-center">
                <h2 class="font-heading text-2xl font-bold mb-4" style="color: hsl(var(--foreground))">
                    Skill not found
                </h2>
                <RouterLink to="/" style="color: hsl(var(--primary))" class="hover:underline">
                    ← Back home
                </RouterLink>
            </div>
        </div>
        ...
        <div v-else class="pt-28 pb-20 container mx-auto px-6">
            ...
            >
                ...
                <div class="flex items-center gap-4 mb-10">
                    ...
                    <div>
                        <h1 class="font-heading text-3xl md:text-4xl font-bold" style="color: hsl(var(--foreground))">
                            {{ skill.name }}
                        </h1>
                        <p style="color: hsl(var(--muted-foreground))">{{ skill.description }}</p>
                    </div>
                </div>
            </div>
            ...
            <div class="space-y-8">
                <article
                    ...
                    :enter="{ opacity: 1, y: 0, transition: { delay: i * 150, duration: 500 } }"
                    class="glass-card rounded-2xl p-6 md:p-8"
                >
                    <h3 class="font-heading text-xl font-semibold mb-3" style="color: hsl(var(--foreground))">
                        {{ project.title }}
                    </h3>
                    <p class="leading-relaxed mb-5" style="color: hsl(var(--muted-foreground))">
                        {{ project.description }}
                    </p>
        
                    <!-- Technologies -->
                    <div class="mb-5">
                        <h4 class="text-xs font-semibold uppercase tracking-wider mb-2" style="color: hsl(var(--primary))">
                            Technologies
                        </h4>
                    ...
                    <div class="mb-6">
                        ...
                        <ul class="space-y-2">
                            <li
                                ...
                                style="color: hsl(var(--muted-foreground))"
                            >
                                <span class="mt-1" style="color: hsl(var(--primary))">•</span>
                                {{ feature }}
                            </li>
                        </ul>
                    </div>
                    ...
                    <!-- Actions -->
                    <div class="flex flex-wrap gap-3 pt-4 border-t" style="border-color: hsl(var(--border))">
